...
with(this){return _c('ul',[_c('li',[_c('p',[_c('strong',[_v("Alternative 1 (current choice):")]),_v(" Create a new command that takes in the required NRIC as an argument.")]),_v(" "),_c('ul',[_c('li',[_v("Pros: Easy to implement, as it has a structure similar to the original Find command.")]),_v(" "),_c('li',[_v("Cons: If users were to input an erratic NRIC, no matching patients will be shown.")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Alternative 2:")]),_v(" Extend the pre-existing Find command to accept NRIC as another argument")]),_v(" "),_c('ul',[_c('li',[_v("Pros: With more parameters, users can look for more patients at one time.\nEven if the user inputs an erratic NRIC, they can still input the patients name\nand receive a list of possible matching patients to choose from.")]),_v(" "),_c('li',[_v("Cons: This is harder to implement as the FilteredList would have to take in more than 1 type of predicate.")])])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.1.0")]),_v(", generated on Fri, 27 Oct 2023, 10:22:41 GMT+8]")])])])}
}];
