...
with(this){return _c('p',[_v("The find patient by NRIC feature is parsed by the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("FindByNricCommandParser")]),_v(" and facilitated the object "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("FindByNricCommand")]),_v(".")])}
},function anonymous(
) {
with(this){return _c('p',[_v("The job of the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("FindByNricCommandParser")]),_v(" is to parse the inputted command word: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find_nric <keyword>")]),_v(".\nAfter parsing the inputted command word, a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("FindByNricCommand")]),_v(" command object is created.\nThis command singles the patient whose NRIC matches the inputted NRIC out of the stored list of unique patients.")])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("The Specifics")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("FindByNricCommandParser")]),_v(" parses the NRIC of the patient that the user wants to look for.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("A "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("FindByNricCommand")]),_v(" is created, together with a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("NricContainsKeywordPredicate")]),_v(" that compares the given NRIC with the NRICs of patients in a list of patients with unique NRICs.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("This predicate is then passed into "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("FindByNricCommand")]),_v(", which then finds the patient whose NRIC matches the inputted NRIC.")])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("In-depth description")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.1.0")]),_v(", generated on Thu, 26 Oct 2023, 22:49:58 GMT+8]")])])])}
}];
