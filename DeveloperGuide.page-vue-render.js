...
with(this){return _c('h3',{attrs:{"id":"proposed-delete-patient"}},[_v("[Proposed] Delete Patient"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#proposed-delete-patient","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The proposed delete mechanism is facilitated by "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("DeleteCommand")]),_v(" and the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("LogicManager")]),_v(" Class.\nClinic staff can enter "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete 3")]),_v(" which deletes all information of the person in the list, including their details and appointment.\nThe following sequence diagram shows how the DeleteCommand class works.")])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('p',[_c('strong',[_v("Alternative 1 (current choice):")]),_v(" Delete based on INDEX shown on the present list")]),_v(" "),_c('ul',[_c('li',[_v("Pros: Intuitive and easy for nurse to delete")]),_v(" "),_c('li',[_v("Cons: Needs to use zero-based indexing since lists are zero-indexed but the view of clinic staff is one-indexed.")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Alternative 2:")]),_v(" Delete based on name of patient")]),_v(" "),_c('ul',[_c('li',[_v("Pros: Will be more accurate when deleting a patient")]),_v(" "),_c('li',[_v("Cons: Takes more time as need to type out names of patient when deleting and length of names may vary from person to person")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Patient visits the clinic")]),_v(" "),_c('li',[_v("Clinic staff needs the information of this specific patient")]),_v(" "),_c('li',[_v("Clinic staff inserts the patient's details")]),_v(" "),_c('li',[_v("ClinicRecords retrieves the patient's information for the clinic staff")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to list patients")])]),_v(" "),_c('li',[_c('p',[_v("ClinicRecords shows a list of patients")])]),_v(" "),_c('li',[_c('p',[_v("User requests to delete a specific person in the list")])]),_v(" "),_c('li',[_c('p',[_v("ClinicRecords deletes the person")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("3a. The given input is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. ClinicRecords shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('em',[_v("{More to be added}")])])}
},function anonymous(
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.1.0")]),_v(", generated on Sat, 11 Nov 2023, 15:42:58 GMT+8]")])])])}
}];
